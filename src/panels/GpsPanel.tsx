...
export default function GpsPanel() {
  ...
  const ctxRef = useRef(createCtx())
  const keys = useRef<Set<string>>(new Set())
  const [mapId, setMapId] = useState('factory')
    ...
    <div className="grid h-full grid-cols-1 gap-3 lg:grid-cols-[1fr_340px]">
      ...
      <div className="flex min-h-0 flex-col gap-3">
        ...
        <div className="efl-panel p-3 text-[11px]">
          <div className="mb-2 uppercase tracking-widest text-emerald-300">Player (simulated)</div>
          ...
          <div className="mt-2 text-emerald-100/40">W/S move · A/D strafe · Q/E turn · Shift sprint</div>
        </div>
